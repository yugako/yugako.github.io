		...
		<div class="row-wrapper">
			<div class="col cl-12 cl-md-6">
				<div class="about-services__item">
					...
					<h4 class="about-services__item-title">Build Single-Page Application</h4>
			...
			<div class="col cl-12 cl-md-6">
				<div class="about-services__item">
					...
					<h4 class="about-services__item-title">WordPress Theme developing</h4>
			...
			<div class="col cl-12 cl-md-6">
				<div class="about-services__item">
					...
					<h4 class="about-services__item-title">Creating sites from exsisting design</h4>
